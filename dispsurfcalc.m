function [wfinal,extraparam]=dispsurfcalc(kc_x_max,kc_z_max,m_i,wp_e)

%DISPSURFCALC Calculates the cold plasma dispersion surfaces
%  [W,EXTRAPAR] = DISPSURFCALC(K_PERP_MAX,K_PAR_MAX,M_I,WP_E)
...
%  DISPSURF is returned as EXTRAPARAM.
%
%  This function is essential for DISPSURF to work.
%
