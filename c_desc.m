...
elseif regexp(vs,'^EB[1-4]$')==1
	...
	v.cs = {'na','na','na','na','na'};
	v.rep = {'scalar','scalar','scalar','scalar','scalar'};
 	v.units =  {'mV/m','mV/m','na','na','na'};
	v.si_conv = {'1.0e-3>V m^-1','1.0e-3>V m^-1','','',''};
	v.size = [ 1 1 1 1 1 1 ];
	v.name = {'Electric field','Electric field','Probe','P_Bitmask','P_Quality'};
    v.quant = 'dibe';
	v.labels = {'Ex','Ey','Probe','Bitmask','Quality'};
	v.field_name = {'Electric field','Electric field','Probe','Bitmask','Quality'};
    v.ptype = {'Data'};
    v.valtype = {'FLOAT','FLOAT','INT','INT','INT'};
    v.sigdig = [ 6 6 4 5 1 ];
	v.ent = {'Electric_Field'};
	v.prop = {'Vector'};
	v.fluc = {'Waveform'};
