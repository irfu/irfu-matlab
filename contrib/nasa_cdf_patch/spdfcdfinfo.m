...
%     (9) The FILLVAL attribute entry values of the variables, if set. 
%     (9) The VALIDMIN attribute entry values of the variables, if set. 
%     (9) The VALIDMAX attribute entry values of the variables, if set. 
%
