function dispsurfplot(kc_x_max,kc_z_max,wfinal,extraparam,surfchoice,colorchoice)

%DISPSURFPLOT Plot the cold plasma dispersion surfaces
%  DISPSURFPLOT(K_PERP_MAX,K_PAR_MAX,W,EXTRAPAR,SURFCHOICE,COLCHOICE)
%  plots the dispersion surfaces calculated by DISPSURFCALC.
% 
%  This function is essential for DISPSURF.
%  
%  K_PERP_MAX = max value of k_perpendicular*c/w_c
%  K_PAR_MAX = max value of k_perpendicular*c/w_c
%  W = the dispersion surfaces from DISPSURFCALC.
%  EXTRAPAR = the extra parameters from DISPSURFCALC
