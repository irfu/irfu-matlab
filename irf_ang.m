function [d]=irf_angle(t1,p1,t2,p2)
%IRF_ANG   Compute the angle between two vectors in degrees
%
% [d]=irf_angle(t1,p1,t2,p2)
% [d]=irf_angle(v1,v2) % column vectors in radial coordinates
% [d]=irf_angle(v1,v2,whatever) % v1,v2 column vectors in xyz
