...
% =========
% varargin
%       At least one argument. All arguments must have the same size in
%       dimension 1.
%
%
% RETURN VALUES
...
%       RATIONALE: This is provided as a pure convenience to the caller who
%       would normally have to derive this anyway.
%
%
