  ...
  methods(Access=private)
      ...
      function test_A_exc(testCase, str, regexpCa)
        testCase.assertError(...
            @() irf.str.regexp_str_parts(str, regexpCa, 'assert match'), ...
            ?MException)
      end
      ...
      function test_P_OK_A_OK(testCase, ...
        ...
        testCase.test_OK(str, regexpCa, 'permit non-match', ...
          expSubStrCa, expRemainingStr, expIsPerfectMatch)
        testCase.test_OK(str, regexpCa, 'assert match', ...
          expSubStrCa, expRemainingStr, expIsPerfectMatch)
      end



      % Test one call for each policy, where permit non-match succeeds but
      % assert match fails.
