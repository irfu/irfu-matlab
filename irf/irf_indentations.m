...
irfDirectories = {...
  ...
  fullfile('mission', 'solar_orbiter', '+solo', '+adm', '+dsfn'), ...
  fullfile('mission', 'solar_orbiter', '+solo', '+hwzv'), ...
  fullfile('mission', 'solar_orbiter', '+solo', '+qli'), ...
  fullfile('mission', 'solar_orbiter', '+solo', '+qli', '+batch'), ...
  ...
  fullfile('mission', 'solar_orbiter', 'bicas', 'src', '+bicas', '+ga'), ...
  fullfile('mission', 'solar_orbiter', 'bicas', 'src', '+bicas', '+ga', '+mods'), ...
  ...
  fullfile('mission', 'solar_orbiter', 'bicas', 'src', '+bicas', '+tools', '+batch'), ...
  fullfile('mission', 'solar_orbiter', 'bicas', 'src', '+bicas', '+tools', '+rct'), ...
  fullfile('mission', 'solar_orbiter', 'bicas', 'src', '+bicas', '+tools', '+rtdp'), ...
  fullfile('mission', 'solar_orbiter', 'bicas', 'src', '+bicas', '+tools', '+vbmc'), ...
  fullfile('mission', 'solar_orbiter', 'bicas', 'src', '+bicas', '+utils'), ...
  fullfile('mission', 'solar_orbiter', 'bicas', 'src', '+bicas', '+utils', '+cli'), ...
