function [xpar]=irf_par(x,y)
%IRF_PAR vector projection parallel to another vector
%
% [xpar]=irf_par(x,y)   return x projection along y
%
...
zout = yn.*repmat(dot(xx,yn,2),1,3);
