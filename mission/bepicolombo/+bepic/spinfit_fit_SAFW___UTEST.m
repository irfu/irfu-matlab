...
classdef spinfit_fit_SAFW___UTEST < matlab.unittest.TestCase
  ...
  methods(Test)
    ...
    function test_all_empty(T)
      ...
      T.verifyEqual(actR.fitWindowCenterTt2000Ar, int64.empty(0, 1))
    ...
    function test_0(T)
      ...
      T.assertEqual(actR.fitWindowCenterTt2000Ar, int64([102.5e9]))
    ...
    function test_1(T)
      ...
      T.assertEqual(actR.fitWindowCenterTt2000Ar, int64([101e9; 103e9]))
    ...
    function test_2(T)
      ...
      T.assertEqual(actR.fitWindowCenterTt2000Ar, int64([101e9; 109e9]))
      T.verifyEqual(actR.offsetAr,          [2; 2], AbsTol=1e-13)
      T.verifyEqual(actR.coefficientCos1Ar, [3; 3], AbsTol=1e-13)
      T.verifyEqual(actR.coefficientSin1Ar, [4; 4], AbsTol=1e-13)
      T.verifyEqual(actR.coefficientCos2Ar, [5; 5], AbsTol=1e-13)
    ...
    function test_data_gap(T)
      ...
      N = ones(4, 1);
      T.verifyEqual(actR.fitWindowCenterTt2000Ar, int64([101e9; 105e9; 203e9; 207e9]))
