...
% bepic.spinfit.fw.get_SAFWs_when_no_data_gaps().
%
%
% Author: Erik P G Johansson, IRF, Uppsala, Sweden
%
classdef utils_get_SAFWs_when_no_data_gaps___UTEST < matlab.unittest.TestCase
  ...
  methods(Test)
    ...
    function test_empty_zero_samples(T)
      ActFitWindowTable = bepic.spinfit.fw.get_SAFWs_when_no_data_gaps( ...
