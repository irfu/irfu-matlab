%
% matlab.unittest automatic test code for bepic.spinfit.fit_SAFW_MMS().
%
%
% Author: Erik P G Johansson, IRF, Uppsala, Sweden
%
classdef spinfit_fit_SAFW_MMS___UTEST < matlab.unittest.TestCase
  ...
  methods(Test)
    ...
    function test_all_empty(T)
      actR = bepic.spinfit.fit_SAFW_MMS( ...
    ...
    %   bepic.spinfit.fit_SAFW_MMS()'s merging of processing results.
