%
% matlab.unittest automatic test code for bepic.spinfit.fit_TAFW_MMS().
%
...
%
classdef spinfit_fit_TAFW_MMS___UTEST < matlab.unittest.TestCase
  ...
  properties(Constant)
    ...
    TIME_WINDOW_CENTER_REF_TT2000 = int64(2e9);
  ...
  methods(Test)
    ...
    function test_empty_arrays(T, N_FIT_COEFF)
      ...
      actR = bepic.spinfit.fit_TAFW_MMS( ...
        ...
        fitWindowCenterRefTt2000 = T.TIME_WINDOW_CENTER_REF_TT2000, ...
    ...
    function test_spin_samples_perfect_fit(T)
      ...
      %     bepic.spinfit.fit_TAFW_MMS() with standard values.
    ...
    function test_spin_samples_too_few(T, N_FIT_COEFF)
      ...
      actR = bepic.spinfit.fit_TAFW_MMS( ...
        ...
        fitWindowLengthNs        = T.TIME_WINDOW_LENGTH_NS, ...
        fitWindowCenterRefTt2000 = T.TIME_WINDOW_CENTER_REF_TT2000, ...
        nMinFitSamples           = 5+3, ...    % NOTE: Required for this test.
        nFitCoefficients         = N_FIT_COEFF);
