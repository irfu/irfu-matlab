...
fomFS = [0.02 0.08 0.3 0.5]; fomFS = fomFS/sum(fomFS); % percentage
...
if 0  
  ...
  avtmNSP1 = (tmAllocationNSP1(1)*mshTM + tmAllocationNSP1(2)*bsTM + tmAllocationNSP1(3)*fsTM + tmAllocationNSP1(4)*pswTM)/sum(tmAllocationNSP1)*tRoiNSP1;
  avtmNSP2 = (tmAllocationNSP2(1)*mshTM + tmAllocationNSP2(2)*bsTM + tmAllocationNSP2(3)*fsTM + tmAllocationNSP2(4)*pswTM)/sum(tmAllocationNSP2)*tRoiNSP2;
  avtmNSP3 = (tmAllocationNSP3(1)*mshTM + tmAllocationNSP3(2)*bsTM + tmAllocationNSP3(3)*fsTM + tmAllocationNSP3(4)*pswTM)/sum(tmAllocationNSP3)*tRoiNSP3;
  ...
  tsAvTM = irf.ts_scalar(dataBS.time,[iOrbNSP1'*0+avtmNSP1*3;iOrbNSP2'*0+avtmNSP2*2;iOrbNSP3'*0+avtmNSP3*1]);  
