...
if     t>=toepoch([2017 11 19 21 00 0]), Ddsi = [ -0.14 1.73  00 -0.13 ];
elseif t>=toepoch([2017 06 23 06 00 0]), Ddsi = [ 0.26 2.44 00 0.25 ]; % Force MS offset for months when don't enter SW.
