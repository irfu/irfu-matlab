...
if t>=toepoch([2024 01 01 00 00 0]), Ddsi = [ 00 00 00 0.29 ];
elseif t>=toepoch([2023 01 01 00 00 0]), Ddsi = [ 00 00 00 0.28 ];
elseif t>=toepoch([2022 01 01 00 00 0]), Ddsi = [ 00 2.47  00 0.26 ];
...
% Table of MS offsets
if t>=toepoch([2024 01 01 00 0 0]), Ddsi = [ 00 00 00 0.55 ];
elseif t>=toepoch([2023 01 01 00 0 0]), Ddsi = [ 00 00 00 0.54 ];
