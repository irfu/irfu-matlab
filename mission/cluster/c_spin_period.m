function [spin_period,err_angle,err_angle_mean, phc_coef] = c_spin_period(phase)
%C_SPIN_PERIOD  Compute cluster spin period
%
% [SPIN_PERIOD,ERR_ANGLE,ERR_ANGLE_MEAN, POL_COEF] = C_SPIN_PERIOD(PHASE_2)
%
...
phc = unwrap(ph(1:2,2)/180*pi); phc_coef = polyfit(ph(1:2,1),phc,1);
if isnan(phc_coef(1))
