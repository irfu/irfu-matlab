...
MMS_CONST.Version = struct(...
  MMS_CONST.SDCProcs{MMS_CONST.SDCProc.ql},    struct('X', 1, 'Y', 7), ...
  MMS_CONST.SDCProcs{MMS_CONST.SDCProc.scpot}, struct('X', 2, 'Y', 4), ...
  MMS_CONST.SDCProcs{MMS_CONST.SDCProc.l2pre}, struct('X', 0, 'Y', 7), ...
  MMS_CONST.SDCProcs{MMS_CONST.SDCProc.l2a},   struct('X', 2, 'Y', 1), ...
