...
MMS_CONST.Version = struct(...
  MMS_CONST.SDCProcs{MMS_CONST.SDCProc.ql},    struct('X', 1, 'Y', 10), ...
  MMS_CONST.SDCProcs{MMS_CONST.SDCProc.scpot}, struct('X', 2, 'Y', 8), ...
  MMS_CONST.SDCProcs{MMS_CONST.SDCProc.l2pre}, struct('X', 2, 'Y', 1), ...
  MMS_CONST.SDCProcs{MMS_CONST.SDCProc.l2a},   struct('X', 3, 'Y', 1), ...
