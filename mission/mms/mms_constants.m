...
MMS_CONST.Version = struct(...
  ...
  MMS_CONST.SDCProcs{MMS_CONST.SDCProc.l2pre}, struct('X', 1, 'Y', 3), ...
...
MMS_CONST.Version.MODS = [MMS_CONST.Version.MODS; {'V.3. L2a (v3.0.z) Slow Mode probe Gain set to 1.0 when orbital radius less than 5 RE (1.25 otherwise), L2pre Slow mode (v1.3.z) DSL offsets dependent on scpot product (probe2plasma).'}];
end
