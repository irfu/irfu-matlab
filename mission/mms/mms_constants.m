...
MMS_CONST.Version = struct(...
  ...
  MMS_CONST.SDCProcs{MMS_CONST.SDCProc.scpot}, struct('X', 2, 'Y', 5), ...
  MMS_CONST.SDCProcs{MMS_CONST.SDCProc.l2pre}, struct('X', 1, 'Y', 0), ...
  MMS_CONST.SDCProcs{MMS_CONST.SDCProc.l2a},   struct('X', 2, 'Y', 2), ...
