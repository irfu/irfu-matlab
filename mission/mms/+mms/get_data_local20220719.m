...
vars = {'R_gse','R_gsm','V_gse','V_gsm',...
  ...
  ...
  'Phplus_hpca_brst_l1b','Pheplus_hpca_brst_l1b','Pheplusplus_hpca_brst_l1b','Poplus_hpca_brst_l1b',...
  'Phplus_hpca_srvy_l1b','Pheplus_hpca_srvy_l1b','Pheplusplus_hpca_srvy_l1b','Poplus_hpca_srvy_l1b',...
  'Phplus_hpca_srvy_l2','Pheplus_hpca_srvy_l2','Pheplusplus_hpca_srvy_l2','Poplus_hpca_srvy_l2',...
  'Oplus_hpca_srvy_l2',...
  ...
  ...
  'Omnifluxoplus_hpca_brst_l2','Omnifluxhplus_hpca_brst_l2',...
  'Omnifluxoplus_hpca_srvy_l2','Omnifluxhplus_hpca_srvy_l2',...
  'Omnifluxheplus_hpca_brst_l2','Omnifluxheplusplus_hpca_brst_l2',...
  'Omnifluxion_epd_feeps_brst_l2', 'Omnifluxelectron_epd_feeps_brst_l2', ...
  'Omnifluxion_epd_feeps_srvy_l2', 'Omnifluxelectron_epd_feeps_srvy_l2', ...
...
switch Vr.inst
  ...
  case 'hpca'
    ...
    switch param
      ...
      case 'P', v = 'ion_pressure'; Vr.cs = 'ion_pressure_hpca';
    ...
    if Vr.to>0 && not(isfield(Vr,'no_cs') && Vr.no_cs)
      switch Vr.cs
        case 'gsm', pref = [pref '_GSM'];
        case 'dbcs'
        case 'ion_pressure_hpca'
  ...
  function res = get_ts(dataType)
    ...
    switch dataType
      ...
      case 'feeps_omni'
        ...
        % Energy specification seems to have been changed in datafile, now
        % it's given for every sensor.
...
hpcaParamsTens2 = {'Thplus','Theplus','Theplusplus','Toplus'};
hpcaParamsTens2_no_cs = {'Phplus','Pheplus','Pheplusplus','Poplus'}; % pressure given with no cs specification
...
switch param
  ...
  case hpcaParamsTens1
    tensorOrder = 1;
  case {hpcaParamsTens2{:}, hpcaParamsTens2_no_cs{:}}
    tensorOrder = 2;
  otherwise
...
% coordinate system not specified for hpca ion_pressure
if tensorOrder > 0 && not(any((strcmp(hpcaParamsTens2_no_cs,param))))
