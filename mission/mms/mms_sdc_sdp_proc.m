...
%         '/path/mm2_fields_hk_101_20150410_v0.0.2.cdf');
%
% 	See also MMS_INIT, MMS_BITMASKING.
...
switch(HeaderInfo.calledBy)
    ...
    case('usc')
        ...
        if( all( [exist('DCV_File', 'var'), exist('HK_SunpulseFile', 'var')] ) )
            ...
            irf.log('debug',['MMS_SDC_SDP_PROC Usc using mms_cdf_in_process on input file: ', DCV_File]);
            [dcv_source, dcv_source_fileData] = mms_cdf_in_process(DCV_File,'sci');
            ...
            irf.log('debug', 'MMS_SDC_SDP_PROC Usc using mms_cdf_write');
    ...
    case('sitl')
        ...
        if( all( [exist('DCE_File', 'var'), exist('HK_SunpulseFile', 'var'), ~exist('DCV_File', 'var')] ) )
            ...
            irf.log('debug',['MMS_SDC_SDP_PROC SITL using mms_cdf_in_process on input file: ', DCE_File]);
            [dce_source, dce_source_fileData] = mms_cdf_in_process(DCE_File,'sci');
            ...
            irf.log('debug', 'MMS_SDC_SDP_PROC SITL using mms_cdf_write');
        ...
        elseif( all( [exist('HK_SunpulseFile','var'), exist('DCE_File','var'), exist('DCV_File','var')] ) )
            ...
            % Then get dcv data
            irf.log('debug',['MMS_SDC_SDP_PROC SITL trying mms_cdf_in_process on input file: ', DCV_File]);
            [dcv_source, dcv_source_fileData] = mms_cdf_in_process(DCV_File,'sci');
    ...
    case('ql')
        ...
        if( all( [exist('DCE_File', 'var'), exist('HK_SunpulseFile', 'var'), ~exist('DCV_File', 'var')] ) )
            ...
            irf.log('debug',['MMS_SDC_SDP_PROC QL using mms_cdf_in_process on input file: ', DCE_File]);
            [dce_source, dce_source_fileData] = mms_cdf_in_process(DCE_File,'sci');
            ...
            irf.log('debug', 'MMS_SDC_SDP_PROC QL using mms_cdf_write');
        ...
        elseif( all( [exist('HK_SunpulseFile','var'), exist('DCE_File','var'), exist('DCV_File','var')] ) )
            ...
            % Then get dcv data
            irf.log('debug',['MMS_SDC_SDP_PROC QL trying mms_cdf_in_process on input file: ', DCV_File]);
            [dcv_source, dcv_source_fileData] = mms_cdf_in_process(DCV_File,'sci');
