...
switch procId
  ...
  case MMS_CONST.SDCProc.l2pre
    ...
    for iPair=1:numel(sdpPair)
      ...
      name.sdev.(sdpPair{iPair}) = [datasetPrefix '_dce_spinfit_sdev_' sdpPair{iPair}];
      % Update output variables
      outVars = [outVars {...
        name.sfits.(sdpPair{iPair}), spinfit.sfit.(sdpPair{iPair}),...
        name.sdev.(sdpPair{iPair}),  spinfit.sdev.(sdpPair{iPair})}];
      recBound = [recBound {...
      ...
      VATTRIB.FIELDNAM = [VATTRIB.FIELDNAM; {...
        ...
        name.sdev.(sdpPair{iPair}),  ['Sdev spinfit ', sdpPair{iPair}]}];
      VATTRIB.FILLVAL = [VATTRIB.FILLVAL; {...
