...
switch procId
  ...
  case MMS_CONST.SDCProc.l2pre
    ...
    % Bitmask, defined as CDF_UINT1 (uint8 in Matlab)
    bitmask = [dce.e12.bitmask, dce.e34.bitmask, dce.e56.bitmask];
    quality = mms_sdp_bitmask2quality('e',bitmask(:,1));
    ...
    VATTRIB.CATDESC = {name.epoch, 'Time tags, in TT2000'; ...
      name.label,      'Label'; ...
      name.dce,        'DC E field [E12, E34, E56]'; ...
    ...
    for iPair=1:numel(sdpPair)
      ...
      % Update VATTRIB
      VATTRIB.CATDESC = [VATTRIB.CATDESC; {...
        name.sfits.(sdpPair{iPair}), ['Spinfit: SDEV and coefs A,B,C: A+B*cos(wt)+C*sin(wt) ', sdpPair{iPair}]}];
      VATTRIB.DEPEND_0 = [VATTRIB.DEPEND_0; {...
