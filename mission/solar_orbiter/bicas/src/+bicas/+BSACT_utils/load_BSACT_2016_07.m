...
function [TcDcc, TcDcv, TcTf] = load_BSACT_2016_07(bsactRootPath)

%=================================
% Register DCC calibration tables
%=================================
TcDcc = bicas.BSACT_utils.reader_DCC_DCV_TF();
...
%=================================
TcDcv = bicas.BSACT_utils.reader_DCC_DCV_TF();
...
%================================
TcTf = bicas.BSACT_utils.reader_DCC_DCV_TF();
