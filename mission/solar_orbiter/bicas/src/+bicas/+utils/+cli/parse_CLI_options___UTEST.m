  ...
  methods(Test)
    ...
    function test0(testCase)
      ...
      OCM1 = containers.Map(...
        {'a', 'b', 'c'}, ...
        {...
        CliOptionConfig('-a', '0-1',   0, 0), ...
        CliOptionConfig('-b', '1',     1, 0), ...
        CliOptionConfig('-c', '0-inf', 2, 0)...
        });
      OCM2 = containers.Map(...
        {'--', '=='}, ...
        {...
      ...
      OCM3 = containers.Map(...
        {'all', 'log', 'set'}, ...
        {...
        CliOptionConfig('--.*',    '0-inf', 1, -1), ...
        CliOptionConfig('--log',   '1',     1, 0), ...
        CliOptionConfig('--set.*', '0-inf', 1, 0) ...
        });
