    ...
    methods(Access=public)
        ...
        function obj = swmode_defs(SETTINGS, L)
            ...
            LFR_SW_MODE_DATA = struct(...
                ...
                'outputSkeletonVersion', {'12', '12', '12', '12'});
            TDS_SW_MODE_DATA = struct(...
                'CWF_RSWF',              {'CWF', 'RSWF'}, ...
                'outputSkeletonVersion', {'12',  '12'});
            ...
            for iInputLevel = 1:numel(inputDatasetLevelList)
                ...
                for iSwm = 1:length(LFR_SW_MODE_DATA)
                    ...
                    SwModeList(end+1) = bicas.swmode_defs.def_swmode(...
                        @(InputDatasetsMap, rctDir, NsoTable) bicas.proc.pf.produce_L2_LFR(...
                            InputDatasetsMap, ...
                            rctDir, ...
                            NsoTable, ...
                ...
                for iSwm = 1:numel(TDS_SW_MODE_DATA)
                    ...
                    SwModeList(end+1) = bicas.swmode_defs.def_swmode(...
                        @(InputDatasetsMap, rctDir, NsoTable) bicas.proc.pf.produce_L2_TDS(...
                            InputDatasetsMap, ...
                            rctDir, ...
                            NsoTable, ...
                            SciInputDef.datasetId, ...
            ...
            if SETTINGS.get_fv('SW_MODES.L2-L3_ENABLED')
                ...
                SwModeList(end+1) = bicas.swmode_defs.def_swmode(...
                    @(InputDatasetsMap, rctDir, NsoTable) (bicas.proc.pf.produce_L3(...
                        InputDatasetsMap, ...
                        SETTINGS, L)), ...
