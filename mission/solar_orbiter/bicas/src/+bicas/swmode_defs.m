    ...
    methods(Access=public)
        ...
        function obj = swmode_defs(SETTINGS, L)
            ...
            if SETTINGS.get_fv('SW_MODES.L2-L3_ENABLED')
                ...
                EfieldDsrOutputDef = bicas.swmode_defs.def_output_dataset(...
                    'out_efield_dsr', ...
                ...
                ScpotDsrOutputDef = bicas.swmode_defs.def_output_dataset(...
                    'out_scpot_dsr', ...
                ...
                DensityDsrOutputDef = bicas.swmode_defs.def_output_dataset(...
                    'out_density_dsr', ...
