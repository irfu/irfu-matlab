...
classdef swmode_defs
    ...
    methods(Access=public)
        ...
        function obj = swmode_defs(SETTINGS, L)
            ...
            for iInputLevel = 1:numel(inputDatasetLevelList)   % Iterate over [L1R] (one component), or [L1, L1R]...
                ...
                for iSwm = 1:length(LFR_SW_MODE_DATA)
                    ...
                    SwModeList(end+1) = bicas.swmode_defs.def_swmode(...
                        ...
                        strmod(...
                            ['Generate <SBMx/SURV> <C/SWF> electric field L2 data (potential difference)', ...
                ...
                for iSwm = 1:numel(TDS_SW_MODE_DATA)
                    ...
                    SwModeList(end+1) = bicas.swmode_defs.def_swmode(...
                        ...
                        strmod(...
                            ['Generate <C/RSWF> electric field L2 data (potential difference)', ...
            ...
            if SETTINGS.get_fv('SW_MODES.L2-L3_ENABLED')
                ...
                EfieldDwnsOutputDef = bicas.swmode_defs.def_output_dataset(...
                    ...
                    'RPW BIAS L3 downsampled science electric field vector data, time-tagged', ...
                    '01');
                ...
                ScpotDwnsOutputDef = bicas.swmode_defs.def_output_dataset(...
                    ...
                    'RPW BIAS L3 downsampled science spacecraft potential data, time-tagged', ...
                    '01');
                ...
                SwModeList(end+1) = bicas.swmode_defs.def_swmode(...
                    @(InputDatasetsMap, rctDir, NsoTable) (bicas.proc.produce_L3(...
                        ...
                        SETTINGS, L)), ...
                    'BIA-EFIELD-SCPOT', ...
                    'Generate L3 electric field vector and spacecraft potential data, incl. additional downsampled versions', ...
                    [SciInputDef], ...
                    [EfieldOutputDef,     ScpotOutputDef, ...
                     EfieldDwnsOutputDef, ScpotDwnsOutputDef]);
            end
    ...
    methods(Static, Access=private)
        ...
        function assert_SW_mode_CLI_option(swModeCliOption)
            EJ_library.assert.castring_regexp(swModeCliOption, bicas.constants.SW_MODE_CLI_OPTION_REGEX)
        end
