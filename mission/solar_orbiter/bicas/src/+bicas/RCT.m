    ...
    methods(Static, Access=public)
        ...
        function path = find_RCT_regexp(rctDir, filenameRegexp, L)
            ...
            if numel(filenameList) == 0
                % ERROR
                error('BICAS:RCT:CannotFindRegexMatchingRCT', ...
        ...
        function [RctData] = read_BIAS_RCT(filePath)
            ...
            try
                ...
                for iEpochL = 1:nEpochL
                    %assert(Bias.ItfSet.DcSingleAvpiv{iEpochL}.eval(0) > 0, 'BICAS:RCT:FailedToReadInterpretRCT', 'DC single inverted transfer function is not positive (and real) at 0 Hz. (Wrong sign?)');
                    %assert(Bias.ItfSet.DcDiffAvpiv{iEpochL}.eval(0)   > 0, 'BICAS:RCT:FailedToReadInterpretRCT',   'DC diff inverted transfer function is not positive (and real) at 0 Hz. (Wrong sign?)');
                ...
                Exc2 = MException(...
                    'BICAS:RCT:FailedToReadInterpretRCT', ...
