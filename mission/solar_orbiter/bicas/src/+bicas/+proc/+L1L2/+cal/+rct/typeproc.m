    ...
    methods(Static, Access=private)
        ...
        function RctTypesMap = init_RCT_TYPES_MAP()
            ...
            RctTypesMap('BIAS') = entry(...
                @bicas.proc.L1L2.cal.rct.fs.read_BIAS_RCT, ...
                @bicas.proc.L1L2.cal.rct.typeproc.modify_BIAS_RCT_data, ...
                @bicas.proc.L1L2.cal.rct.typeproc.log_BIAS_RCT, ...
                'PROCESSING.RCT_REGEXP.BIAS');
            
            RctTypesMap('LFR') = entry(...
                @bicas.proc.L1L2.cal.rct.fs.read_LFR_RCT, ...
                @bicas.proc.L1L2.cal.rct.typeproc.modify_LFR_RCT_data, ...
                @bicas.proc.L1L2.cal.rct.typeproc.log_LFR_RCTs, ...
                'PROCESSING.RCT_REGEXP.LFR');
            
            RctTypesMap('TDS-CWF') = entry(...
                @bicas.proc.L1L2.cal.rct.fs.read_TDS_CWF_RCT, ...
                @bicas.proc.L1L2.cal.rct.typeproc.modify_TDS_CWF_RCT_data, ...
                @bicas.proc.L1L2.cal.rct.typeproc.log_TDS_CWF_RCTs, ...
                'PROCESSING.RCT_REGEXP.TDS-LFM-CWF');
            
            RctTypesMap('TDS-RSWF') = entry(...
                @bicas.proc.L1L2.cal.rct.fs.read_TDS_RSWF_RCT, ...
                @bicas.proc.L1L2.cal.rct.typeproc.modify_TDS_RSWF_RCT_data, ...
                @bicas.proc.L1L2.cal.rct.typeproc.log_TDS_RSWF_RCTs, ...
        ...
        function log_BIAS_RCT(RctData, L)
            ...
            LL               = bicas.proc.L1L2.cal.rct.typeproc.RCT_DATA_LL;
            ...
            for iLsf = 1:4
                ...
                for iBlts = 1:nBltsMax
                    ...
                    bicas.proc.L1L2.cal.utils.log_TF_tabulated(...
                        bicas.proc.L1L2.cal.rct.typeproc.RCT_DATA_LL, ...
                        itfName, ...
        ...
        function log_TDS_CWF_RCTs(RctData, L)
            ...
            L.logf(bicas.proc.L1L2.cal.rct.typeproc.RCT_DATA_LL, ...
