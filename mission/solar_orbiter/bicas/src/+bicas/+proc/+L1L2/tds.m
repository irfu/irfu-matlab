...
classdef tds    
    ...
    methods(Static)
        ...
        function [OutSci] = process_PostDC_to_CDF(SciPreDc, SciPostDc, outputDsi, L)
            ...
            nSamplesPerRecordChannel = size(SciPostDc.Zv.DemuxerOutput.get('DC_V1'), 2);
            ...
            if C.isCwf
                ...
                OutSci.Zv.VDC(:,1) = SciPostDc.Zv.DemuxerOutput.get('DC_V1');
                OutSci.Zv.VDC(:,2) = SciPostDc.Zv.DemuxerOutput.get('DC_V2');
                OutSci.Zv.VDC(:,3) = SciPostDc.Zv.DemuxerOutput.get('DC_V3');

                OutSci.Zv.EDC(:,1) = SciPostDc.Zv.DemuxerOutput.get('DC_V12');
                OutSci.Zv.EDC(:,2) = SciPostDc.Zv.DemuxerOutput.get('DC_V13');
                OutSci.Zv.EDC(:,3) = SciPostDc.Zv.DemuxerOutput.get('DC_V23');

                OutSci.Zv.EAC(:,1) = SciPostDc.Zv.DemuxerOutput.get('AC_V12');
                OutSci.Zv.EAC(:,2) = SciPostDc.Zv.DemuxerOutput.get('AC_V13');
                OutSci.Zv.EAC(:,3) = SciPostDc.Zv.DemuxerOutput.get('AC_V23');
