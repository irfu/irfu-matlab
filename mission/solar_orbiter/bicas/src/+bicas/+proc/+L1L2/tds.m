    ...
    methods(Static)
                    ...
                    switch(settingValue)
                        case 'ROUND'
                            bicas.default_anomaly_handling(...
                                ...
                                anomalyDescrMsg, ...
                                'BICAS:L1L2:process_normalize_CDF:Assertion:DatasetFormat')
        ...
        % snapshots. Need to use NaN/fill value.
            ...
            assert(...
                ...
                'BICAS:L1L2:process_CDF_to_PreDC:Assertion:DatasetFormat', ...
        ...
        function [OutSci] = process_PostDC_to_CDF(SciPreDc, SciPostDc, outputDsi, L)
            ...
            if C.isCwf
                ...
                assert(nSamplesPerRecordChannel == 1, ...
                    'BICAS:L1L2:Assertion:IllegalArgument', ...
            ...
            elseif C.isSwf
                ...
                error('BICAS:L1L2:Assertion:IllegalArgument', ...
