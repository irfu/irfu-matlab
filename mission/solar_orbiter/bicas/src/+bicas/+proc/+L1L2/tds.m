    ...
    methods(Static)
        ...
        function InSciNorm = process_normalize_CDF(InSci, inSciDsi, SETTINGS, L)
            ...
            if C.isTdsRswf
                ...
                zv_SAMPS_PER_CH_corrected = max( zv_SAMPS_PER_CH_corrected, EJ_library.so.hwzv.constants.TDS_RSWF_SNAPSHOT_LENGTH_MIN);
                zv_SAMPS_PER_CH_corrected = min( zv_SAMPS_PER_CH_corrected, EJ_library.so.hwzv.constants.TDS_RSWF_SNAPSHOT_LENGTH_MAX);
                ...
                if any(zv_SAMPS_PER_CH_corrected ~= InSci.Zv.SAMPS_PER_CH)
                    ...
                    anomalyDescrMsg = sprintf(...
                        ...
                        ' interval %.0f to %.0f: %s'], ...
                        EJ_library.so.hwzv.constants.TDS_RSWF_SNAPSHOT_LENGTH_MIN, ...
                        EJ_library.so.hwzv.constants.TDS_RSWF_SNAPSHOT_LENGTH_MAX, ...
                        badValuesDisplayStr);
        ...
        % snapshots. Need to use NaN/fill value.
            ...
            if C.isTdsRswf   assert(nCdfSamplesPerRecord == EJ_library.so.hwzv.constants.TDS_RSWF_SAMPLES_PER_RECORD)
            ...
            elseif C.isSwf
                ...
                if     C.isLfr
                    SAMPLES_PER_RECORD_CHANNEL = ...
                        EJ_library.so.hwzv.constants.LFR_SWF_SNAPSHOT_LENGTH;
                elseif C.isTds
                    SAMPLES_PER_RECORD_CHANNEL = ...
                        EJ_library.so.hwzv.constants.TDS_RSWF_SAMPLES_PER_RECORD;
                else
                    error(...
                        'BICAS:Assertion', ...
