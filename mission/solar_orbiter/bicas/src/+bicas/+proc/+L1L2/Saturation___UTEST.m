  ...
  methods(Test)
    ...
    function test_get_voltage_saturation_quality_bit___zero_records(testCase)
      for hasSwfFormat = 0:1
        ...
        testCase.test_get_voltage_saturation_quality_bit(testCase, ...
          ...
          bltsKSsidAr               = string.empty(0, bicas.const.N_BLTS), ...
          isAchg                    = zeros(0, 1), ...
    ...
    function test_get_voltage_saturation_quality_bit___CWF_DC_diff(testCase)
      ...
      testCase.test_get_voltage_saturation_quality_bit(testCase, ...
        ...
        bltsKSsidAr               = repmat(testCase.BDM0_DLR0_ROW, 3, 1), ...
        isAchg                    = [0 0 0]', ...
        hasSwfFormat              = false, ...
        ...
    ...
    function test_get_voltage_saturation_quality_bit___CWF_AC_diff(testCase)
      ...
      testCase.test_get_voltage_saturation_quality_bit(testCase, ...
        ...
        bltsKSsidAr               = repmat(testCase.BDM0_DLR0_ROW, 10, 1), ...
    ...
    function test_get_voltage_saturation_quality_bit___mult_subsequences(testCase, HAS_SWF_FORMAT)
      ...
      AsrSamplesAVoltSrm = bicas.utils.SameRowsMap("bicas.proc.L1L2.AntennaSignalId", 10, 'EMPTY');
      AsrSamplesAVoltSrm.add(testCase.S("DC_V1").Asid,  [2 0 0 0 0   2 0 0 0 0]')
      AsrSamplesAVoltSrm.add(testCase.S("DC_V12").Asid, [0 3 0 0 0   0 3 0 0 0]')
      AsrSamplesAVoltSrm.add(testCase.S("DC_V23").Asid, [0 0 3 0 0   0 0 3 0 0]')
      AsrSamplesAVoltSrm.add(testCase.S("DC_V2").Asid,  [0 0 0 2 0   0 0 0 2 0]')
      AsrSamplesAVoltSrm.add(testCase.S("DC_V3").Asid,  [0 0 0 0 2   0 0 0 0 2]')
      ...
      testCase.test_get_voltage_saturation_quality_bit(testCase, ...
        ...
        ...
        expIsSaturatedAr          = [1 1 1 0 0   1 0 0 1 1]');
    end
    ...
    function test_get_voltage_saturation_quality_bit___SWF_1(testCase)
      ...
      testCase.test_get_voltage_saturation_quality_bit(testCase, ...
        ...
        bltsKSsidAr               = repmat(testCase.BDM0_DLR0_ROW, 2, 1), ...
        isAchg                    = [0 1]', ...
        hasSwfFormat              = true, ...
        ...
    ...
    function test_get_voltage_saturation_quality_bit___SWF_2(testCase)
      ...
      testCase.test_get_voltage_saturation_quality_bit(testCase, ...
        ...
        bltsKSsidAr               = repmat(testCase.BDM0_DLR0_ROW, 4, 1), ...
        isAchg                    = [0 0 1 1]', ...
        hasSwfFormat              = true, ...
        ...
