  ...
  methods(Access=public)
    ...
    function OutputDatasetsMap = production_function(obj, ...
      ...
      if useCtRcts
        ...
        RcttCaMap = bicas.proc.L1L2.cal.rct.findread.find_read_RCTs_by_regexp_and_CALIBRATION_TABLE(...
          tdsRcttid, rctDir, ...
        ...
        RcttCaMap = bicas.proc.L1L2.cal.rct.findread.find_read_RCTs_by_regexp(...
          {'BIAS', tdsRcttid}, rctDir, Bso, L);
      end

      Cal = bicas.proc.L1L2.cal.Cal(RcttCaMap, useCtRcts, useCti2, Bso);
