...
classdef qual___UTEST < matlab.unittest.TestCase
    ...
    methods(Test)
        ...
        function test_set_voltage_current_fill_value(testCase)
            ...
            test( ...
                int64([10, 11, 12, 13, 14]'), ...
                logical([0, 1, 0, 1, 1]'), ...
                bicas.proc.L1L2.qual___UTEST.DemuxerOutput([1, 2, 3, 4, 5]'), ...
                [1:3; 11:13; 21:23; 31:33; 41:43],  ...
                bicas.proc.L1L2.qual___UTEST.DemuxerOutput([1, NaN, 3, NaN, NaN]'), ...
    ...
    methods(Static, Access=private)
        ...
        function DemuxerOutput = DemuxerOutput(v)
            assert(iscolumn(v))
            DemuxerOutput = bicas.utils.SameRowsMap(...
