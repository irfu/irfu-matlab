...
classdef qual___UTEST < matlab.unittest.TestCase
    ...
    methods(Test)
        ...
        function test_modify_quality_filter(testCase)
            ...
            ENA           = zeros(0, 1);
            ECA           = cell(0, 1);
            ENA_UINT8_FPA = bicas.utils.FillPositionsArray(uint8(ENA), 'fill value', uint8(255));
            ...
            if 1
                ...
                ZvIn = struct(...
                    'Epoch',               int64([0:9]'*1e9), ...
                    'bdmFpa',              bicas.utils.FillPositionsArray(uint8([0, 0, 1, 2, 0, 0, 0, 0, 0, 0]'), 'fill value', uint8(255)), ...
            ...
            if 1
                ...
                ZvIn = struct(...
                    'Epoch',               int64([0:4]'*1e9), ...
                    'bdmFpa',              bicas.utils.FillPositionsArray(...
                                             uint8([0, 0,  0,     0,     0]'), 'fill value', uint8(255)), ...
        ...
        function test_get_UFV_records_from_settings(testCase)
            ...
            function actZvUfv = call_func(zv_Epoch, zvBdmDoubleNan, isLfr, bdmRemoveArray, lfrBdmMarginSec, tdsBdmMarginSec)
                ...
                zvBdmFpa = bicas.utils.FillPositionsArray(zvBdmDoubleNan, 'fill value', NaN).cast('int8', 0);
