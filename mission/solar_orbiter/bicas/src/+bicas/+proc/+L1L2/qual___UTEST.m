...
classdef qual___UTEST < matlab.unittest.TestCase
    ...
    methods(Test)
        ...
        function test_get_UFV_records_from_settings(testCase)
            ...
            function actZvUfv = call_func(zv_Epoch, zvBdm, isLfr, bdmRemoveArray, lfrBdmMarginSec, tdsBdmMarginSec)
                SETTINGS = bicas.create_default_SETTINGS();
            ...
            if 1
                for isLfr = [false, true]
                    ...
                    for bdmRemoveArrayCa = {[], zeros(0,1), [2]', [1,2,3]'}
                        ...
                        test(int64(zeros(0, 1)), zeros(0, 1), isLfr, bdmRemoveArray, 10, 20, false(0, 1))
