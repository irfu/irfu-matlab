...
classdef sat
  ...
  methods(Static)
    ...
    %     SatSettings, uspr, zvSamplesAVolt, ssid, isAchgFpa)
    %
    ...
    %       SatSettings, ...
    %       zvSamplesAVolt(iRec, 1:uspr(iRec)), ...
    %       ssid, isAchgFpa);
    %   end
    % end
    ...
    %     Bso, tt2000Ar, AsrSamplesAVoltSrm, uspr, ...
    ...
    %     SatSettings, ssid, isAchgFpa, samplesAVolt, uspr)
    %
    %   [nRows, ~] = irf.assert.sizes( ...
    %     ssid,         [ 1], ...
    %     isAchgFpa,    [-1], ...
