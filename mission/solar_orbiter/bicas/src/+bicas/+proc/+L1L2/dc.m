...
%                 dlrUsing12zv(bNan) = NaN;
            ...
            [iFirstList, iLastList, nSs] = irf.utils.split_by_change(...
                PreDc.Zv.MUX_SET, ...
                PreDc.ZvFpa.DIFF_GAIN.logical2doubleNan(), ...
                PreDc.Zv.freqHz, ...
                PreDc.Zv.iLsf, ...
                PreDc.Zv.CALIBRATION_TABLE_INDEX, ...
                PreDc.Zv.ufv, ...
                PreDc.Zv.lfrRx, ...
                dlrUsing12Fpa.logical2doubleNan(), ...
                iCalibLZv, ...
                iCalibHZv);
        ...
        function SsAsrSamplesAVoltSrm = calibrate_demux_subsequence(...
            ...
            Fpa_DIFF_GAIN_ss           = PreDc.ZvFpa.DIFF_GAIN(           iFirst);    % Temporary variable. Should be eliminated eventually.
            DIFF_GAIN_ss               = Fpa_DIFF_GAIN_ss.logical2doubleNan();       
            ...
            if ~(PreDc.hasSnapshotFormat && PreDc.isLfr)
                ...
                L.logf('info', ['Records %8i-%8i : %s -- %s', ...
                    ...
                    dlrUsing12Fpa_ss.logical2doubleNan(), ...
                    freqHz_ss, ...
