...
%                 PreDc.Zv)
            ...
            [iFirstList, iLastList, nSs] = irf.utils.split_by_change(...
                PreDc.ZvFpa.bdm.int2doubleNan(), ...
                PreDc.ZvFpa.biasHighGain.logical2doubleNan(), ...
                PreDc.Zv.freqHz, ...
                PreDc.Zv.iLsf, ...
        ...
        function SsAsrSamplesAVoltSrm = calibrate_demux_subsequence(...
            ...
            % records.
            bdmFpa_ss                  = PreDc.ZvFpa.bdm(                 iFirst);
            bdm_ss                     = bdmFpa_ss.int2doubleNan();
            biasHighGainFpa_ss         = PreDc.ZvFpa.biasHighGain(        iFirst);    % Temporary variable. Should be eliminated eventually.
