...
%   CON: Might want to share instance field S = bicas.proc.L1L2.const.C.SSID_DICT;
  ...
  methods(Test)
    ...
    function test_get_VSIB(testCase)
      ...
      function test(satArgsCa, ssidStr, isAchg, samplesAVolt, expVsibAr)
        ...
        actVsibAr = bicas.proc.L1L2.sat.get_VSIB(...
    ...
    function test_get_VSIB_NEW(testCase)
      ...
      function test(samplesAVolt, ssidStrAr, isAchgFpa, expVsibAr)
        ...
        testCase.assertEqual(actVsibAr, logical(expVsibAr))
      end
    ...
    function test_get_snapshot_VSQB(testCase)
      ...
      function main()
        ...
        % test_get_VSIB() tests the different types of thresholds. The
    ...
    function test_get_ASR_CWF_channel_VSIB___DC(testCase)
      testCase.test_get_ASR_CWF_channel_VSIB(testCase, ...
        thresholdAVoltDcSingle = 1, ...
        thresholdAVoltDcDiff   = 3, ...
        thresholdAVoltAclg     = 5, ...
        thresholdAVoltAchg     = 7, ...
    ...
    function test_get_ASR_CWF_channel_VSIB___AC(testCase)
      testCase.test_get_ASR_CWF_channel_VSIB(testCase, ...
        thresholdAVoltDcSingle = 1, ...
        thresholdAVoltDcDiff   = 3, ...
        thresholdAVoltAclg     = 5, ...
  ...
  methods(Static, Access=private)
    ...
    function test_get_ASR_CWF_channel_VSIB(testCase, V)
      arguments
        testCase
        V.cwfSlidingWindowLengthSec
        V.vsibFractionThreshold
      ...
      SatSettings = testCase.init_SatSettings(...
        ...
        vsibFractionThreshold, ...
        V.thresholdAVoltDcSingle, ...
        V.thresholdAVoltDcDiff, ...
        V.thresholdAVoltAclg, ...
        V.thresholdAVoltAchg);

      actVsibAr = bicas.proc.L1L2.sat.get_ASR_CWF_channel_VSIB(...
    ...
    function test_get_ASR_SWF_channel_VSQB(testCase, V)
      ...
      actVsibAr = bicas.proc.L1L2.sat.get_ASR_SWF_channel_VSQB(...
    ...
    function Bso = init_BSO(...
      ...
      Bso.override_value('PROCESSING.SATURATION.SAMPLE_FRACTION_THRESHOLD',                vsibFractionThreshold,     'test');
