%
% matlab.unittest automatic test code for bicas.proc.L1L2.autodetect_sweeps().
%
%
...
classdef autodetect_sweeps___UTEST < matlab.unittest.TestCase
  ...
  methods(Static, Access=private)
    ...
    function test(testCase, S)
      ...
      Bso.override_value('PROCESSING.L2.DETECT_SWEEPS.SBDA.END_UTC',   spdfbreakdowntt2000(S.sbdaEndTt2000),     'test');
      ...
      actIsSweepingFpa = bicas.proc.L1L2.autodetect_sweeps(S.tt2000, bdmFpa, hkBiasCurrentFpa, Bso);
