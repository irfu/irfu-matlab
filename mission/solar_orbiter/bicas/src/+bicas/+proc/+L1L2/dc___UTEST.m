...
classdef dc___UTEST < matlab.unittest.TestCase
  ...
  methods(Test)
    ...
    function test0(testCase)
      ...
      testCase.test_get_demuxer_routings_arrays(...
  ...
  methods(Access=private)
    ...
    function test_get_demuxer_routings_arrays(testCase, bdmFpa, dlrFpa, expBltsKSsidArray, expBltsKSdidArray)
      [actBltsKSsidArray, actBltsKSdidArray] = bicas.proc.L1L2.dc.get_demuxer_routings_arrays(bdmFpa, dlrFpa);
