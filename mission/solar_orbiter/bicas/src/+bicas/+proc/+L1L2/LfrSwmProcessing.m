...
classdef LfrSwmProcessing < bicas.proc.SwmProcessing
  ...
  methods(Access=public)
    ...
    function OutputDatasetsMap = production_function(obj, ...
      ...
      if useCtRcts
        RcttMap = bicas.proc.L1L2.cal.rct.findread.find_read_RCTs_by_regexp_and_CALIBRATION_TABLE(...
          'LFR', rctDir, ...
        ...
        RcttMap = bicas.proc.L1L2.cal.rct.findread.find_read_RCTs_by_regexp(...
          {'BIAS', 'LFR'}, rctDir, Bso, L);
      end

      Cal = bicas.proc.L1L2.cal.Cal(RcttMap, useCtRcts, useCti2, Bso);
