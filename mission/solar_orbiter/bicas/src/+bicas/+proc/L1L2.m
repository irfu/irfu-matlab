    ...
    %#############################
        ...
        function HkSciTime = process_HK_CDF_to_HK_on_SCI_TIME(InSci, InHk, SETTINGS, L)
            ...
            bdmDoubleNan = bicas.utils.interpolate_nearest(...
                    ...
                    InSci.Zv.Epoch);
            HkSciTime.bdmFpa = bicas.utils.FillPositionsArray(bdmDoubleNan, 'FILL_VALUE', NaN).cast('uint8');
            ...
            %==================================================================
            HkSciTime.biasHighGainFpa = bicas.utils.FillPositionsArray.floatNan2logical(...
            ...
            HkSciTime.dlrFpa = bicas.utils.FillPositionsArray.floatNan2logical(...
                bicas.utils.interpolate_nearest(...
                    hkEpochExtrapMargin, ...
                    hkEpoch, ...
