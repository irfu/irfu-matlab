    ...
    methods(Access=public)
        ...
        function obj = cal(NonBiasRctDataMap, rctDir, ...
            ...
            switch(settingBiasTf)
                ...
                otherwise
                    error(...
                        'BICAS:cal:Assertion:ConfigurationBug', ...
...
%                 'iCalibTimeL', 'iCalibTimeH'}, {'iLsf'})   % Too slow?
            ...
            if obj.use_CALIBRATION_TABLE_INDEX2
                ...
                error('BICAS:cal:Assertion:IllegalCodeConfiguration:OperationNotImplemented', ...
...
%                 'iCalibTimeL', 'iCalibTimeH'}, {'iLsf'})   % Too slow?
            ...
            if obj.use_CALIBRATION_TABLE_INDEX2
                % TODO? ASSERTION: cti2 = 0???
                error(...
                    'BICAS:cal:Assertion:IllegalCodeConfiguration:OperationNotImplemented', ...
            ...
            switch(BltsSrc.category)
                ...
                case 'DC diff'
                    ...
                    elseif isequal(BltsSrc.antennas(:)', [2,3]);   offsetAVolt = BiasRct.DcDiffOffsets.E23AVolt(iCalibTimeH);
                        ...
                        error('BICAS:cal:Assertion:IllegalArgument', ...
                            'Illegal BltsSrc.');
                    end
        ...
        function lfrItfIvpt = get_LFR_ITF(obj, cti1, iBlts, iLsf)
            ...
            if (iLsf == 4) && ismember(iBlts, [4,5])
                ...
                assert(numel(RctDataList) >= (cti1+1), ...
                    'BICAS:cal:IllegalArgument:DatasetFormat:Assertion', ...
...
%                 'iCalibTimeL', 'iCalibTimeH', 'iLsf'}, {})   % Too slow?
            ...
            if obj.use_CALIBRATION_TABLE_INDEX2
                ...
                assert(isscalar(cti2), ...
                    'BICAS:cal:IllegalArgument:Assertion', ...
    ...
    methods(Static, Access=public)
        ...
        function [iCalib] = get_calibration_time(Epoch, CalibEpochList)
            ...
            bicas.proc.utils.assert_zv_Epoch(CalibEpochList)
...
%             
%             error('BICAS:cal:OperationNotImplemented', 'Function not implemented Yet.')
%         end
