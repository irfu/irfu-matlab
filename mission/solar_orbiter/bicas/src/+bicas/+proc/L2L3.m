    ...
    %#############################
        ...
        function [OutEfieldOsr,  OutEfieldDsr, ...
            ...
            InitialOsr = struct(...
                ...
                'Zv', InitialOsrZv);
            %
            [InitialDsrZv, iRecordsInBinCa] = bicas.proc.dsr.init_shared_downsampled(...
                InLfrCwf, ...
                BIN_LENGTH_WOLS_NS, ...
            ...
            [OutEfieldDsr.Zv.EDC_SRF, ...
             OutEfieldDsr.Zv.EDCSTD_SRF] = bicas.proc.dsr.downsample_sci_zVar(...
            ...
            [OutScpotDsr.Zv.SCPOT, ...
             OutScpotDsr.Zv.SCPOTSTD] = bicas.proc.dsr.downsample_sci_zVar(...
            ...
            %
            [OutScpotDsr.Zv.PSP, ...
             OutScpotDsr.Zv.PSPSTD] = bicas.proc.dsr.downsample_sci_zVar(...
                OutScpotOsr.Zv.PSP, ...
                bicas.constants.N_MIN_SAMPLES_PER_DSR_BIN, ...
                iRecordsInBinCa, ...
                L);
            ...
            [OutDensityDsr.Zv.DENSITY, ...
             OutDensityDsr.Zv.DENSITYSTD] = bicas.proc.dsr.downsample_sci_zVar(...
