...
classdef L2L2    
    ...
    methods(Static)
        ...
        function OutLfrCwfDsr = process_LFRCWF_to_DSR(InLfrCwf, SETTINGS, L)
            ...
            %
            [Zv, iRecordsInBinCa] = bicas.proc.dsr.init_shared_downsampled(...
                InLfrCwf, ...
                BIN_LENGTH_WOLS_NS, ...
            ...
            %===============================================
            [OutLfrCwfDsr.Zv.VDC, ...
             OutLfrCwfDsr.Zv.VDCSTD] = bicas.proc.dsr.downsample_sci_zVar(...
                zv_VDC, ...
            ...
            [OutLfrCwfDsr.Zv.EDC, ...
             OutLfrCwfDsr.Zv.EDCSTD] = bicas.proc.dsr.downsample_sci_zVar(...
                zv_EDC, ...
                bicas.constants.N_MIN_SAMPLES_PER_DSR_BIN, ...
                iRecordsInBinCa, ...
                L);
