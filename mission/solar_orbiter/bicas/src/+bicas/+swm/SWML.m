        ...
        function obj = SWML(SETTINGS, L)
            ...
            for iInputLevel = 1:numel(inputDatasetLevelList)
                ...
                for iSwm = 1:length(LFR_SWM_DATA)
                    ...
                    SciOutputDef = bicas.swm.OutputDataset(...
                        'out_sci', ...
            ...
            if SETTINGS.get_fv('SWM.L2-L3_ENABLED')
                ...
                EfieldOutputDef = bicas.swm.OutputDataset(...
                    'out_efield', ...
                ...
                ScpotOutputDef = bicas.swm.OutputDataset(...
                    'out_scpot', ...
                ...
                DensityOutputDef = bicas.swm.OutputDataset(...
                    'out_density', ...
                ...
                EfieldDsrOutputDef = bicas.swm.OutputDataset(...
                    'out_efield_dsr', ...
                ...
                ScpotDsrOutputDef = bicas.swm.OutputDataset(...
                    'out_scpot_dsr', ...
                ...
                DensityDsrOutputDef = bicas.swm.OutputDataset(...
                    'out_density_dsr', ...
