...
classdef const
  ...
  methods(Static, Access=private)
    ...
    function MAP = init_SWD_metadata()
      ...
      % """"""""
      MAP('SWD.release.version')            = '8.0.0';
      MAP('SWD.release.date')               = '2024-01-17T17:49:00Z';
    ...
    function Gmdb = init_GA_MODS_DB()
      ...
      Gmdb.add_GMVE(L2_TDS_DSIs, bicas.gamods.VersionEntry(...
        '2021-02-02', '5.0.0', ...
      ...
      Gmdb.add_GMVE(L2_LFR_TDS_DSIs, ...
        bicas.gamods.VersionEntry('2024-01-11', '8.0.0', ...
        {...
