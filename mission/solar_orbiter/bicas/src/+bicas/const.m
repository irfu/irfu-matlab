...
classdef const
  ...
  methods(Static, Access=private)
    ...
    function QrcsL2Map = init_QRCS_L2_MAP()
      ...
      QrcsL2Map(bicas.const.QRCID.PARTIAL_SATURATION) = ...
      ...
      QrcsL2Map(bicas.const.QRCID.FULL_SATURATION) = ...
        bicas.proc.QrcSetting(...
        uint8(0), ...
      ...
      QrcsL2Map(bicas.const.QRCID.THRUSTER_FIRING) = ...
        bicas.proc.QrcSetting(...
        uint8(1), ...
    ...
    function QrcsL3Map = init_QRCS_L3_MAP_DENSITY()
      ...
      QrcsL3Map(bicas.const.QRCID.BAD_DENSITY) = ...
        bicas.proc.QrcSetting(...
        uint8(1), ...
