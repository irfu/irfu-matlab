...
classdef const
  ...
  %           bicas.classify_BICAS_L1_L1R_to_L2_DSID() or reverse.
  %
  % PROPOSAL: Lists for both official+unofficial DSIDs.
  ...
  properties(Constant)
    ...
    L2_LFR_TDS_DSID_CA = [...
      bicas.const.L2_LFR_DSID_CA; ...
      bicas.const.L2_TDS_DSID_CA];
    L2_CWF_DSID_CA = {
      'SOLO_L2_RPW-LFR-SBM1-CWF-E'; ...
      'SOLO_L2_RPW-LFR-SBM2-CWF-E'; ...
      'SOLO_L2_RPW-LFR-SURV-CWF-E'; ...
    ...
    L2_SWF_DSID_CA = {
      ...
      'SOLO_L2_RPW-TDS-LFM-RSWF-E'}
    %
    L3_SURV_DENSITY_DSID_CA = {...
      'SOLO_L3_RPW-BIA-DENSITY'; ...
      'SOLO_L3_RPW-BIA-DENSITY-10-SECONDS'};
    L3_SURV_EFIELD_DSID_CA = {...
      'SOLO_L3_RPW-BIA-EFIELD'; ...
      'SOLO_L3_RPW-BIA-EFIELD-10-SECONDS'};
    L3_SURV_SCPOT_DSID_CA = {...
      'SOLO_L3_RPW-BIA-SCPOT'; ...
      'SOLO_L3_RPW-BIA-SCPOT-10-SECONDS'};
    L3_SBMx_DENSITY_DSID_CA = {...
      'SOLO_L3_RPW-BIA-SBM1-DENSITY'; ...
      'SOLO_L3_RPW-BIA-SBM2-DENSITY'};
    L3_SBMx_EFIELD_DSID_CA = {...
      'SOLO_L3_RPW-BIA-SBM1-EFIELD'; ...
      'SOLO_L3_RPW-BIA-SBM2-EFIELD'};
    L3_SBMx_SCPOT_DSID_CA = {...
      'SOLO_L3_RPW-BIA-SBM1-SCPOT'; ...
      'SOLO_L3_RPW-BIA-SBM2-SCPOT'};
    ...
    L3_SBMx_DSID_CA = [ ...
      bicas.const.L3_SBMx_DENSITY_DSID_CA; ...
      bicas.const.L3_SBMx_EFIELD_DSID_CA; ...
      bicas.const.L3_SBMx_SCPOT_DSID_CA];

    RCT_DSID = 'SOLO_CAL_RPW-BIAS';
