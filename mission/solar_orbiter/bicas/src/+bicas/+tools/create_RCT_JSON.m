...
% ==========================
% """"""""
% Please find attached an "dummy" example of what the RCT catalog JSON file could look like.
% 
...
% 	- File must be delivered by teams with any new RCT file in the cal/ subfolder in the LESIA sftp server 
% 
%     And to make it simple as possible:
% 
%     - No header 
%     - One field (JSON object) per RCT file (e.g. "SOLO_CAL_RCT-LFR-SCM_V20190123171020.cdf")
%     - Each RCT field gives at least one validity time range (i.e., "validity_start" and "validity_end"). 
% 
% 
% Let me know if you have comments or suggestions of improvement (if not I will assume that you approve the proposed content).
