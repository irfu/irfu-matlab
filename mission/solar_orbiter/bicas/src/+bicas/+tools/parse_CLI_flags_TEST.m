...
FlagsConfigMap = containers.Map(...
        {'a', 'b', 'c'}, ...
        {...
            struct('cliFlagString', '-a', 'occurrenceRequirement', '0-1',   'nValues', 0), ...
            struct('cliFlagString', '-b', 'occurrenceRequirement', '1',     'nValues', 1), ...
            struct('cliFlagString', '-c', 'occurrenceRequirement', '0-inf', 'nValues', 2)...
        });
