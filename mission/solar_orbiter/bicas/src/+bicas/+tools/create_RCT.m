...
%
% Script for creating the GSE (not RODP) BIAS RCT. Reads a master file, and using it, creates a version with
% calibration data added to it.
% NOTE: The calibration data is hard-coded in this file.
%
...
% (1) it saves work when updating the master CDF (generated from master Excel file), including making inofficial
...
% (3) it is easier to edit if the RCT is extended with more data (in particular more transfer functions, by some multiple).
...
% RCTs in DataPool git repository 2018-02-13 (commit 5cfb4b6):
% ./Excel/ROC-SGSE_CAL_RCT-BIAS_V01.xlsx
% ./Excel/ROC-SGSE_CAL_RCT-BIAS_V02.xlsx
% ./Excel/ROC-SGSE_CAL_RCT-LFR-BIAS_V01.xlsx
% ./Excel/ROC-SGSE_CAL_RCT-LFR-SCM_V01.xlsx
% ./Excel/ROC-SGSE_CAL_RCT-LFR-VHF_V01.xlsx
% ./Excel/ROC-SGSE_CAL_RCT-TDS-LFM-CWF-B_V01.xlsx
% ./Excel/ROC-SGSE_CAL_RCT-TDS-LFM-CWF-E_V01.xlsx
% ./Excel/ROC-SGSE_CAL_RCT-TDS-LFM-RSWF-B_V01.xlsx
% ./Excel/ROC-SGSE_CAL_RCT-TDS-LFM-RSWF-E_V01.xlsx
% ./Excel/ROC-SGSE_CAL_RCT-TDS-SURV-SWF-B_V01.xlsx
% ./Excel/ROC-SGSE_CAL_RCT-TDS-SURV-SWF-E_V01.xlsx
% ./Excel/SOLO_CAL_RCT-SCM_V01.xlsx
% ./Master/ROC-SGSE_CAL_RCT-BIAS_V02.cdf
% ./Skeleton/ROC-SGSE_CAL_RCT-BIAS_V02.skt
% NOTE/TODO-NEED-INFO: People seem to use the wrong file names?
%
% TEST CALL: bicas.tools.create_RCT('/home/erjo/temp/RCT_creation_test/ROC-SGSE_CAL_RCT-BIAS_V02.cdf', '/home/erjo/temp/RCT_creation_test/')
%
...
%============================================================
if PRODUCE_CORRECT_RCT_FILENAME
    destFilename = sprintf('ROC-SGSE_CAL_RCT-BIAS_V%s.cdf', datestr(clock, 'yyyymmddHHMM'));
else
    destFilename = sprintf('ROC-SGSE_CAL_RCT-BIAS_V%s.cdf', 'yyyymmddHHMM');    % DEBUG. Useful for debugging if filename does not constantly change.
end
