function create_RCT(rctMasterCdfFile, destDir, useOfficialRctFilename, pipelineName)
%
...
% pipelineName           : String. 'ROC-SGSE'/'RGTS' or 'RODP'.
% 
%
% RATIONALE
% =========
...
if useOfficialRctFilename
    switch pipelineName
        ...
        otherwise
            error('Can not interpret "pipelineName=%s', pipelineName)
    end
else
