...
% NOTE: One should presumably not change these since the version number is
%       (presumably) tied to the time interval.
...
% RCT version number
% ------------------
% NOTE: Shall presumably be incremented for new RCT versions which have the same
...
rctPath     = bicas.tools.rct.create_RCT(rctMasterCdfFile, destDir, BEGIN_DT, END_DT, RCT_VERSION_NBR);
