  ...
  methods(Access=private)
    ...
    function ActBpcsArray = test1(T, ...
      ...
      SWM_1 = bicas.swm.SoftwareMode(...
        ...
        bicas.swm.InputDataset( 'cli_in',  DSID_1, 'IN_cdf'), ...
        bicas.swm.OutputDataset('cli_out', DSID_2, 'OUT_cdf', 'SWD name', 'SWD descr.', '02') ...
        );
      SWM_2 = bicas.swm.SoftwareMode(...
        SWMP, 'CLI_SWM_2', 'SWD purpose', ...
        bicas.swm.InputDataset( 'cli_in',  DSID_2, 'IN_cdf'), ...
        bicas.swm.OutputDataset('cli_out', DSID_3, 'OUT_cdf', 'SWD name', 'SWD descr.', '03') ...
        );
    ...
    function ActBpcsArray = test2(T, inputPathsCa, referenceDir, outputDir, outputVerAlgorithmId)
      ...
      DSID_1a = 'SOLO_L1R_RPW-LFR-SURV-CWF-E';
      DSID_1b = 'SOLO_L1_RPW-BIA-CURRENT';
      DSID_2  = 'SOLO_L2_RPW-LFR-SURV-CWF-E';
      ...
      SWM_1 = bicas.swm.SoftwareMode(...
        SWMP, 'CLI_SWM_1', 'SWD purpose', ...
        [...
        bicas.swm.InputDataset( 'cli_in1',  DSID_1a, 'IN_1_cdf'); ...
        bicas.swm.InputDataset( 'cli_in2',  DSID_1b, 'IN_2_cdf') ...
        ], ...
        bicas.swm.OutputDataset('cli_out', DSID_2, 'OUT_cdf', 'SWD ', 'SWD ', '02') ...
        );
      SWM_2 = bicas.swm.SoftwareMode(...
        SWMP, 'CLI_SWM_2', 'SWD purpose', ...
        bicas.swm.InputDataset( 'cli_in',  DSID_2, 'IN_cdf'), ...
        [
        bicas.swm.OutputDataset('cli_out1', DSID_3a, 'OUT_1_cdf', 'SWD ', 'SWD ', '03'); ...
        bicas.swm.OutputDataset('cli_out2', DSID_3b, 'OUT_2_cdf', 'SWD ', 'SWD ', '03') ...
        ] ...
        );
