...
classdef run_BICAS_all_passes___UTEST < matlab.unittest.TestCase
    ...
    methods(Test)
        ...
        function test1_1_to_01_ref_collision(testCase, FN_VER_ALGO)
            ...
            irf.fs.create_empty_file(fullfile(P.in,  'solo_L1R_rpw-lfr-surv-cwf-e_20240101_V02.cdf'));
            irf.fs.create_empty_file(fullfile(P.ref, 'solo_L2_rpw-lfr-surv-cwf-e_20240101_V05.cdf'));    % Not V01.
        ...
        function test1_2_to_1_and_crash_to_1(testCase, FN_VER_ALGO)
            ...
            INPUT_FILE_1 =                       fullfile(P.in, 'solo_L1R_rpw-lfr-surv-cwf-e_20240101_V02.cdf');  % Crashes
            irf.fs.create_empty_file(INPUT_FILE_1);
            irf.fs.create_empty_file(fullfile(P.in, 'solo_L1R_rpw-lfr-surv-cwf-e_20240102_V02.cdf'));
        ...
        function test2_1_to_2_ref_collision(testCase, FN_VER_ALGO)
            [testDir, P] = bicas.tools.batch.run_BICAS_all_passes___UTEST.get_test_dirs(testCase, {'in', 'ref', 'out'});
            irf.fs.create_empty_file(fullfile(P.in,  'solo_L2_rpw-lfr-surv-cwf-e_20240101_V01.cdf'));
            irf.fs.create_empty_file(fullfile(P.ref, 'solo_L3_rpw-bia-density_20240101_V01.cdf'));
