  ...
  methods(Test)
    ...
    function test0(T)
      ...
      BPCI_1 = bicas.tools.batch.BicasProcessingCallInfo(...
        ...
        'cli_input',  'DSID_1', INPUT_FILE_1), ...
        bicas.tools.batch.BpciOutput(...
        'cli_output', 'DSID_2', OUTPUT_FILE_1));

      BPCI_2 = bicas.tools.batch.BicasProcessingCallInfo(...
        'CLI_SWM_2', ...
        bicas.tools.batch.BpciInput(...
        'cli_input',  'DSID_1', INPUT_FILE_2), ...
        [...
        bicas.tools.batch.BpciOutput(...
        'cli_output', 'DSID_2', OUTPUT_FILE_2a); ...
        bicas.tools.batch.BpciOutput(...
        'cli_output', 'DSID_3', OUTPUT_FILE_2b) ...
        ]...
        );
