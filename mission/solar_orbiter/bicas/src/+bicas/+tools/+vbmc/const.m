...
classdef const   % < handle
    ...
    properties(Constant)
        ...
        % NOTE: Most of global attributes names have just been copied from defacto
        ...
        EXACT_L2_GLOBAL_ATTRIBUTES = {...
            ...
            'SPECTRAL_RANGE_MAX', 'SPECTRAL_RANGE_MIN', 'SPICE_KERNELS', 'Skeleton_version', 'Software_name', 'Software_version', 'Source_name', ...
        ...
        MANDATORY_L2_ZV_NAMES = {...
            ...
            'Epoch', 'QUALITY_BITMASK', 'L2_QUALITY_BITMASK', 'QUALITY_FLAG', 'SAMPLING_RATE', 'SYNCHRO_FLAG'};
        
        % ACQUISITON_TIME* temporary. Should be abolished.
        SOMETIMES_L2_ZV_NAMES = {'ACQUISITION_TIME', 'ACQUISITION_TIME_LABEL', 'ACQUISITION_TIME_UNITS', 'BW'};
