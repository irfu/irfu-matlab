...
classdef DsiEntry___UTEST < matlab.unittest.TestCase
    ...
    methods(Test)
        ...
        function test_add_version_entry___one(testCase)
        ...
        function test_add_version_entry___reuse_date(testCase)
            Gmde = bicas.gamods.DsiEntry();
        ...
        function test_add_version_entry___reuse_BICAS_version(testCase)
            Gmde = bicas.gamods.DsiEntry();
        ...
        function test_add_version_entry___reuse_date_BICAS_version_1(testCase)
            Gmde = bicas.gamods.DsiEntry();
        ...
        function test_add_version_entry___reuse_date_BICAS_version_2(testCase)
            Gmde = bicas.gamods.DsiEntry();
        ...
        function test_add_version_entry___reuse_date_illegal(testCase)
