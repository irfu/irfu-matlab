...
classdef interpret_CLI_args___UTEST < matlab.unittest.TestCase
  ...
  methods(Test)
    ...
    function test0(testCase)
      ...
      bicas.interpret_CLI_args___UTEST.test(testCase, ...
        ...
        'HELP', [], [], [], 'MATLAB_LOG_FILE_OPTION_ID', {{},{}}, {{},{}});
      ...
      bicas.interpret_CLI_args___UTEST.test(testCase, ...
        ...
        'SW_MODE', 'SWM', [], [], [], {{}, {}}, {{'in', 'out'}, {'infile', 'outfile'}});

      % + extra
      bicas.interpret_CLI_args___UTEST.test(testCase, ...
        {'SWM', '--in', 'infile', '--config', 'configfile', '--out', 'outfile'}, ...
        'SW_MODE', 'SWM', 'configfile', [], [], {{}, {}}, {{'in', 'out'}, {'infile', 'outfile'}});
  ...
  methods(Static, Access=private)
    ...
    function test(testCase, ...
        cliArgList, bfm, swmArg, configFile, ...
