...
classdef gamods
  ...
  methods(Static, Access=private)
    ...
    function Gmdb = init_GA_MODS_DB()
      ...
      % BICAS v9.3.0: Planned L3 EFIELD (SCPOT?) delivery ~2026-06-15
      Gmdb.add_GMVE(...
        [bicas.const.L3_SURV_EFIELD_DSID_CA], ...
        bicas.ga.mods.VersionEntry("2026-06-10", "9.3.0", ...
        ["Updated E field calibration data."; ...
        "Take advantage of better L2 data quality handling."]))
      Gmdb.add_GMVE(...
        [bicas.const.L3_SURV_SCPOT_DSID_CA], ...
        bicas.ga.mods.VersionEntry("2026-06-10", "9.3.0", ...
        ["Updated s/c potential calibration data."; ...
        "Take advantage of better L2 data quality handling."]))
