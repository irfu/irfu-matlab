  ...
  methods(Static, Access=private)
    ...
    function Gmdb = init_GA_MODS_DB()
      ...
      ALL_DSI_CA = [...
        ...
        bicas.const.L3_SURV_DSI_CA; ...
        bicas.const.L3_SBMx_DSI_CA; ...
        ];
      ...
      Gmdb.add_GMVE(bicas.const.L3_SURV_DSI_CA, ...
        bicas.ga.mods.VersionEntry('2024-01-11', '8.0.0', ...
        {['Updated L3 CDF skeletons to remove LFR from', ...
        ' GAs Dataset_ID, Descriptor, and SKELETON_PARENT.']}))
      Gmdb.add_GMVE(bicas.const.L3_SURV_DENSITY_DSI_CA, ...
        bicas.ga.mods.VersionEntry('2024-01-11', '8.0.0', ...
      ...
      Gmdb.add_GMVE(...
        [bicas.const.L3_SURV_EFIELD_DSI_CA; ...
        bicas.const.L3_SURV_SCPOT_DSI_CA], ...
        bicas.ga.mods.VersionEntry('2025-06-26', '8.5.0', ...
      ...
      Gmdb.add_GMVE(...
        bicas.const.L2_LFR_TDS_DSI_CA, ...
        bicas.ga.mods.VersionEntry('2025-12-03', '9.0.0', ...
        {['Cap QUALITY_FLAG<=1 and remove ANT3 bias current when ANT3 is unintentionally floating.']}))
