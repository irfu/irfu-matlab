...
%===========================================================================================================
S.define_setting('SWD_IDENTIFICATION.project',     'ROC');
S.define_setting('SWD_IDENTIFICATION.name',        'BIAS Calibration Software (BICAS)');
S.define_setting('SWD_IDENTIFICATION.identifier',  'BICAS');
S.define_setting('SWD_IDENTIFICATION.description', 'Calibration software which tries to derive electric field L2/L2S datasets from electric L1R LFR and TDS (LFM) datasets.');
S.define_setting('SWD_IDENTIFICATION.icd_version', '1.2 draft 2019-07-11');    % ILlegal format?

S.define_setting('SWD_RELEASE.version',            '0.1.0');
S.define_setting('SWD_RELEASE.date',               '2018-01-22');
S.define_setting('SWD_RELEASE.author',             'Erik P G Johansson, BIAS team');
S.define_setting('SWD_RELEASE.contact',            'erik.johansson@irfu.se');
S.define_setting('SWD_RELEASE.institute',          'IRF-U');
S.define_setting('SWD_RELEASE.modification',       'No modification (initial release)');
S.define_setting('SWD_RELEASE.source',             'https://github.com/irfu/irfu-matlab/commits/SOdevel');    % Appropriate branch?
%S.define_setting('SWD_RELEASE.source',             'https://github.com/irfu/irfu-matlab/commits/master');
%
