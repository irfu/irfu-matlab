...
function Test = test_data_DCC()
    ...
    exp = EJ_library.utils.empty_struct([0,1], ...
        'antennaSignals', ...
        'stimuliOhm', ...
        'testIdNbr', ...
    ...
    exp(end+1) = create_calib_table_record_DCC(100, -30);
    exp(end+1) = create_calib_table_record_DCC(101,   0);
    exp(end+1) = create_calib_table_record_DCC(102,  30);
    ...
    exp(end+1) = create_calib_table_record_DCC(103, -30);
    exp(end+1) = create_calib_table_record_DCC(104,   0);
    exp(end+1) = create_calib_table_record_DCC(105,  30);
    ...
    exp(end+1) = create_calib_table_record_DCC(106, -30);
    exp(end+1) = create_calib_table_record_DCC(107,   0);
    exp(end+1) = create_calib_table_record_DCC(108,  30);
    ...
    Test = EJ_library.atest.CompareFuncResult(@solo.BSACT_utils.parse_testlogbook_DCC_DCV_TF_IC, {rowList, 'DCC'}, {exp});
    
end



function Record = create_calib_table_record_DCC(testIdNbr, inputVoltageLogbookVolt)
...
function Test = test_data_DCV_TF()
    ...
    exp(end+1) = create_calib_table_record_DCV_TF(11, 0, 2, [1 2], NaN, 1, 0);
    exp(end+1) = create_calib_table_record_DCV_TF(12, 0, 3, [2 3], NaN, 0, 0);
    exp(end+1) = create_calib_table_record_DCV_TF(13, 0, 4, [1 2], 5,   1, 0);
    exp(end+1) = create_calib_table_record_DCV_TF(14, 0, 4, [1 2], 100, 1, 0);
    exp(end+1) = create_calib_table_record_DCV_TF(15, 0, 5, [2 3], 5,   0, 0);
    exp(end+1) = create_calib_table_record_DCV_TF(16, 0, 5, [2 3], 100, 0, 0);
    exp(end+1) = create_calib_table_record_DCV_TF(17, 1, 1, [2],   NaN, 0, 0);
    exp(end+1) = create_calib_table_record_DCV_TF(18, 1, 3, [2 3], NaN, 0, 0);
    exp(end+1) = create_calib_table_record_DCV_TF(19, 3, 2, [2],   NaN, 0, 0);
    exp(end+1) = create_calib_table_record_DCV_TF(20, 3, 3, [1 2], NaN, 1, 0);
    exp(end+1) = create_calib_table_record_DCV_TF(21, 4, 2, [2],   NaN, 0, 0);
    ...
    exp(end+1) = create_calib_table_record_DCV_TF(32, 0, 2, [1 2], NaN, 0, 1);
    exp(end+1) = create_calib_table_record_DCV_TF(33, 0, 4, [1 2], 5,   0, 1);
    exp(end+1) = create_calib_table_record_DCV_TF(34, 0, 4, [1 2], 100, 0, 1);
    exp(end+1) = create_calib_table_record_DCV_TF(35, 3, 3, [1 2], NaN, 0, 1);
    ...
    exp(end+1) = create_calib_table_record_DCV_TF(36, 0, 3, [2 3], NaN, 0, 1);
    exp(end+1) = create_calib_table_record_DCV_TF(37, 0, 5, [2 3], 5,   0, 1);
    exp(end+1) = create_calib_table_record_DCV_TF(38, 0, 5, [2 3], 100, 0, 1);
    exp(end+1) = create_calib_table_record_DCV_TF(39, 1, 3, [2 3], NaN, 0, 1);
    ...
    exp(end+1) = create_calib_table_record_DCV_TF(43, 4, 1, [1], NaN, 0, 0);
    exp(end+1) = create_calib_table_record_DCV_TF(44, 4, 2, [2], NaN, 0, 0);
    exp(end+1) = create_calib_table_record_DCV_TF(45, 4, 3, [3], NaN, 0, 0);
    ...
    Test = EJ_library.atest.CompareFuncResult(@solo.BSACT_utils.parse_testlogbook_DCC_DCV_TF_IC, {rowList, 'DCV'}, {exp});
    
end



function Test = test_data_IC()
    % NOTE: In a sence, kind of silly test since it contains all the data in
