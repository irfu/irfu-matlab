...
%
% Reads a file file on the format of the files generated by the actual BIAS standalone calibration campaign. It
% (1) reads the file's numeric table by disregarding comments, and labels the columns according to
% arguments.
% (2) interprets some of the comments as "registers" and extracts the values as strings together with associated
% comment strings.
% Example:
% """"""""
...
% data                     : Struct with one field per column and in addition the following field:
%   .mheader.regX            X = any one of several numbers, depending on file contents.
