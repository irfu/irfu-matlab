  ...
  methods(Test)
    ...
    function test_get_days_from_FMDs_from_file_info(testCase)
      ...
      function test(...
          ...
          qliPathsCa, qliFmdStrCa, ...
          expDaysStrCa)

        [DsmdArray, ~] = solo.adm.paths_to_DSMD_array(datasetPathsCa);
        DatasetFmdDtArray = datetime(datasetsFmdStrCa);
      ...
      test( ...
        ...
        cell(0, 1), ...
        {'SOLO_L2_SWA-PAS-EFLUX'}, ...
        {'/data/20240101T00_20240102T00.png'}, ...
        {'2025-01-01'}, ...
        cell(0, 1) ...
        )
      ...
      % Two datasets, one younger and one older than QLI.
      test( ...
        { ...
        '/data/solo_L2_swa-pas-eflux_20240101_V02.cdf';
      ...
      % Two datasets, both older than QLI.
      test( ...
        { ...
        '/data/solo_L2_swa-pas-eflux_20240101_V02.cdf';
        '/data/solo_L2_mag-rtn-normal_20240101_V02.cdf'
    ...
    function test_merge_dictionaries_max(testCase)
      ...
      function test(DictCa, keyType, valueType, ExpDict)
        ActDict = solo.qli.batch.fmd.merge_dictionaries_max(...
