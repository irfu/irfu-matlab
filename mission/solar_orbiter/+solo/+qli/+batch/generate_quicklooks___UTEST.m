...
classdef generate_quicklooks___UTEST < matlab.unittest.TestCase
  ...
  methods(Test)
    ...
    function test_one_day_24h6h2h(testCase)
      DaysDtArray = solo.qli.utils.umddt('2024-01-01');
    ...
    function test_one_day_week_7days(testCase)
      DaysDtArray     = solo.qli.utils.umddt('2024-01-01');
      ExpDt7daysArray = solo.qli.utils.umddt('2023-12-27');
      Gql = solo.qli.batch.GenerateQuicklooksTest();
    ...
    function test_two_days_24h6h2h_exception(testCase)
      DaysDtArray = solo.qli.utils.umddt('2024-01-01') + caldays([0; 1]);
    ...
    function test_two_weeks_7days_exception(testCase)
      DaysDtArray     = solo.qli.utils.umddt('2024-01-01') + caldays( [0; 2]);  % Mon, Wed
    ...
    function test_complex(testCase)
      DaysDtArray     = solo.qli.utils.umddt('2024-01-01') + caldays([0; 1; 10; 11]); % Mon-Tue, Wed-Thu
      ExpDt7daysArray = solo.qli.utils.umddt('2023-12-27') + calweeks([0; 2]);        % Skip middle week.
