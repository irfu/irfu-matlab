...
classdef parse_dataset_filename___UTEST < matlab.unittest.TestCase
  ...
  methods(Test)
    ...
    function test0(testCase)
      ...
      function test_parse(filename, expR, expTimeIntervalStr)
        [actR, actTimeIntervalStr] = solo.adm.dsfn.parse_dataset_filename(filename);

        testCase.assertEqual(actR, expR)
        testCase.assertEqual(actTimeIntervalStr, expTimeIntervalStr)
      end
      ...
      function test_both(filename, R, expTimeIntervalStr)
        % NOTE: Tests pair of conversions: one in each direction.
        test_parse(filename, R, expTimeIntervalStr)
      ...
      test_both(...
        ...
        '20170531T173115-20170531T173215');
      test_both(...
        ...
        '20190523T080316-20190523T134337');
      ...
      test_both(...
        ...
        'timeIntervalFormat', 'SECOND_TO_SECOND'), ...
        '20190102T030405-20201112T131415');
      test_both(...
