...
classdef time   % < handle
    ...
    methods(Static)
        ...
        function tt2000wols = TT2000_to_TT2000WOLS(tt2000)
            ...
            % NOTE: Not SDN.
            dayNbr = datenum(double(v(:,1:3))) - EJ_library.cdf.time.TT2000WOLS_EPOCH_SDN;
            
            % int64 if v is int64.
            tt2000wols = EJ_library.utils.mixed_radix.MRD_to_integer(...
                [fliplr(v(:, 4:9)), dayNbr], ...
                [1000, 1000, 1000, 60, 60, 24, EJ_library.cdf.time.TT2000WOLS_DAY_RANGE]');
        ...
        function tt2000 = TT2000WOLS_to_TT2000(tt2000wols)
            ...
            mrd = EJ_library.utils.mixed_radix.integer_to_MRD(...
                tt2000wols, ...
                [1000, 1000, 1000, 60, 60, 24, EJ_library.cdf.time.TT2000WOLS_DAY_RANGE]');
            ...
            if tt2000wols < 0
                ...
                dayNbr = dayNbr - EJ_library.cdf.time.TT2000WOLS_DAY_RANGE;
            end
            % SDN
            sdn = dayNbr + EJ_library.cdf.time.TT2000WOLS_EPOCH_SDN;
