...
% ARGUMENTS
% =========
% tt2000 : Nx1 numeric array. N>=0. Does not have to be int64.
%
%
% RETURN VALUE
% ============
% dateVec : Nx6 numeric array. (i,:) = MATLAB date vector. See MATLAB function "datevec".
...
function dateVecUtc = tt2000_to_datevec(tt2000)
    ...
    % IMPLEMENTATION NOTE: Rounding to nine digits is good for automatic testing. Eliminates some of arbitrariness in
