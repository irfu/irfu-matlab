...
classdef const
    ...
    properties(Constant)
        ...
        LSF_HZ = [...
            EJ_library.so.hwzv.const.LFR_F0_HZ, ...
            EJ_library.so.hwzv.const.LFR_F1_HZ, ...
            EJ_library.so.hwzv.const.LFR_F2_HZ, ...
        ...
        TM_PER_SAMPERE = 32768 / EJ_library.so.hwzv.const.MAX_ABS_SAMPERE;
    end
