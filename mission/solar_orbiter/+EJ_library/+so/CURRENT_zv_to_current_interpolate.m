%
% Utility function for easily deriving (set) current at arbitrary timestamps
% almost directly from SOLO_L1_RPW-BIA-CURRENT dataset zVariables. Therefore has
% some extra features to handle the quirks of the dataset format.
%
...
% ARGUMENTS
% ==========
% t1        : 1D vector. Time. Sorted. Type unimportant (linear increasing with
%             time). Can be TT2000.
...
% RETURN VALUE
% ============
% zvIBIASx2         : Current values at t2. Double. NaN for timestamps before
