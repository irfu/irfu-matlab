...
TcDcc = so.BSACT_utils.reader_DCC_DCV_TF_IC();
...
%=================================
TcDcv = so.BSACT_utils.reader_DCC_DCV_TF_IC();
...
%================================
TcTf  = so.BSACT_utils.reader_DCC_DCV_TF_IC();
...
%================================
TcIc  = so.BSACT_utils.reader_DCC_DCV_TF_IC();
