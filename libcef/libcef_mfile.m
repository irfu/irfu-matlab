...
%This function was generated by loadlibrary.m parser version 1.1.6.38 on Mon Sep  2 18:08:52 2013
%perl options:'libcef.i -outfile=libcef_mfile.m -thunkfile=libcef_thunk_maci64.c -header=libcef.h'
ival={cell(1,0)}; % change 0 to the actual number of functions to preallocate the data.
structs=[];enuminfo=[];fcnNum=1;
fcns=struct('name',ival,'calltype',ival,'LHS',ival,'RHS',ival,'alias',ival,'thunkname', ival);
MfilePath=fileparts(mfilename('fullpath'));
ThunkLibName=fullfile(MfilePath,'libcef_thunk_maci64');
