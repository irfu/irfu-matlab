function [S,f]=irf_model_galactic_background_radiation(varargin)
% IRF_MODEL_GALACTIC_BACKGROUND_RADIATION does something good for space scientist
%	[S,f]=IRF_MODEL_GALACTIC_BACKGROUND_RADIATION() returns the galactic
%	radiation in (V^2/m^2/Hz) and frequency vector in Hz
%
%	[S]=IRF_MODEL_GALACTIC_BACKGROUND_RADIATION(f) returns the galactic
%	radiation at the given frequency f in (V^2/m^2/Hz)
%
%	[S]=IRF_MODEL_GALACTIC_BACKGROUND_RADIATION(f,'W') returns the galactic
%	radiation at the given frequency f in (W/m^2/Hz/sr)
%
% 	IRF_MODEL_GALACTIC_BACKGROUND_RADIATION('plot') plots the spectra in new
% 	window with units  (V^2/m^2/Hz)
%
% 	IRF_MODEL_GALACTIC_BACKGROUND_RADIATION('plot','W') plots the spectra in new
% 	window with units  (W/m^2/Hz/sr)
%
%	Example:
%		S=IRF_MODEL_GALACTIC_BACKGROUND_RADIATION(1e6); % radiation at 1MHz
%
