...
% Set quality to zero on SCP level 3 NaN values
...
% Quality factors:
QUALITY_RESET                    =  [ 0 1 ]; % SCPQuality 1
QUALITY_BAD_BIAS                 =  [ 0 1 ]; % SCPQuality 1
QUALITY_PROBE_SATURATION         =  [ 0 1 ]; % SCPQuality 1
QUALITY_LOW_DENSITY_SATURATION   =  [ 0 1 ]; % SCPQuality 1
...
QUALITY_WHISPER_OPERATING        =  [ 2 0 ]; % SCPQuality 0
QUALITY_HIGH_BIAS_SATURATION     =  [ 1 2 ]; % SCPQuality 2
