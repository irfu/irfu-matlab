function out = EncodeEpoch16(epoch, varargin)
%EncodeEpoch16 encodes an epoch of CDF_EPOCH16 data type, an double array value
%
%   OUT = EncodeEpoch16(epoch) 
...
if (nargin < 1)
    error('MATLAB:ENCODEEPOCH16:inputArgumentCount', ...
          'ENCODEEPOCH16 requires at least one input argument.')
end

if (nargout > 1)
    error('MATLAB:ENCODEEPOCH16:outputArguments', ...
          'ENCODEEPOCH16 requires only one output argument.')
end
...
out = encodeepoch16c(epoch, args.Format);
%%%
