...
%% PC3-5
if wantPC35
    E3D_4SEC = irf_edb(E_4SEC,B_5VPS,15); % Ez
    t_4SEC = ((tint(1)+2):4:tint(end))';
    B_4SEC = irf_resamp(B_5VPS,t_4SEC);
    
    %XXX to construct inert
    ...
    [timeVector,frequencyVector,BVector,BB_xxyyzz_fac,EESum_xxyyzz_ISR2,EE_xxyyzz_FAC,...
        ...
        irf_ebsp(E3D_4SEC,B_4SEC,B0_1MIN,R,'pc35');
    h=irf_pl_ebsp(cl_id,R,timeVector,'pc35',BVector,BB_xxyyzz_fac,...
