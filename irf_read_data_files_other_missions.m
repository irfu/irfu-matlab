...
switch lower(data_source)
    ...
    case 'dmsp_ssj'
        ...
        res.AvgEi=C(:,14);
        ii=15;
        res.eCts=C(:,ii:ii+18);ii=ii+18;
        res.eDef=C(:,ii:ii+18);ii=ii+18;
        res.eErr=C(:,ii:ii+18);ii=ii+18;
        res.iCts=C(:,ii:ii+18);ii=ii+18;
        res.iDef=C(:,ii:ii+18);ii=ii+18;
        res.iErr=C(:,ii:ii+18);ii=ii+18;
