...
title(h(1),sprintf('MMS%d',mmsId))
legend(h(1),'E L2pre','E l2','V_{e}xB','V_{i}xB','V_{H+}xB','Location','NorthEastOutside')
legend(h(2),'E L2pre','E l2','V_{e}xB','V_{i}xB','V_{H+}xB','Location','NorthEastOutside')
legend(h(3),'E L2pre','E l2','V_{e}xB','V_{i}xB','V_{H+}xB','Location','NorthEastOutside')
