function OUT=getburstheader(filename)

%GETBURSTHEADER Get the Cluster EFW internal burst header
%
% HEADERTIME=GETBURSTHEADER('FILENAME') reads the EFW burst header
